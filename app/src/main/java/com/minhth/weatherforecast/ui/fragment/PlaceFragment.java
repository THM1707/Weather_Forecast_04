...
public class PlaceFragment extends Fragment implements View.OnClickListener,
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        SharedPreferences sharedPreferences = getActivity().getSharedPreferences(PREFERENCE_NAME,
    ...
    private void showData(ForecastResponseModel model) {
        ...
        if (model!= null) {
            ...
            Toast.makeText(getActivity(), R.string.msg_no_information, Toast.LENGTH_SHORT).show();
        }
    }
